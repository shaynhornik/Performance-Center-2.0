...
def dashboard():
    ...
    if emp_id:
        ...
        q = (
            sb
            .table("estimate_assigned_employees_flat")
        ...
        # b) chunked count of non-canceled estimates
        total = 0
        if estimate_ids:
            ...
            for i in range(0, len(ids), 100):
                ...
                c = (
                    ...
                    .in_("id", chunk)
                    .filter("work_status", "not.in", "(pro canceled,user canceled)")
                    .execute()
                ).count or 0
                total += c
        kpi_values["total_opportunities"] = total
    ...
    saved_order = layout.data.get("layout_json") or [] if layout and layout.data else []
